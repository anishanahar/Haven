  ...
  return (
    <div className={cn("flex items-center gap-2 font-semibold tracking-tight", className)}>
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect width="28" height="28" rx="8" fill="url(#haven-logo-gradient)" />
        <path
        ...
        <defs>
          <linearGradient id="haven-logo-gradient" x1="0" y1="0" x2="28" y2="28" gradientUnits="userSpaceOnUse">
            <stop stopColor="#4F8CFF" />
            <stop offset="1" stopColor="#7CFFB2" />
          </linearGradient>
        </defs>
      </svg>
      <span className="text-lg">Haven</span>
    </div>
  );
}
